...
Anchor records the accepted baseline for review.
...
The recursion has a resolution narrative;
`bootstrap-resolution` walks it.
The reader-facing speaking positions and italics convention live in `perspective-and-terms`.
