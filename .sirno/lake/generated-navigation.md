...
`structural-edge-policy` defines the shared edge names and Tide behavior.
Mist settings choose which structural links appear in one projected workspace.

The reservoir and mist design makes misty lakes the render surface.
...
A change to footer rendering, mist render settings, ownership boundaries, or structural link policy
